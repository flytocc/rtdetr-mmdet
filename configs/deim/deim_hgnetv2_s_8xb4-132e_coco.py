_base_ = '../dfine/dfine_hgnetv2_s_8xb4-132e_coco.py'
...
custom_keys.update({
    ...
    for block_id in range(num_blocks) for lid in range(3)
})
custom_keys.update({
    ...
    for block_id in range(num_blocks) for lid in range(3) for cid in (1, 2)
})
custom_keys.update({
